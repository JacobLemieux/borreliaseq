...
plt.ylabel("-log10(P)")
plt.legend(bbox_to_anchor=(1.12, 0.9))
plt.savefig("../results/figures/paper/Figure_7A_with_legend.pdf")
plt.close()
...
plt.savefig("../results/figures/paper/Figure_8A.pdf")
plt.close()
...
plt.savefig("../results/figures/paper/Figure_8B.pdf")
plt.close()
...
plt.savefig("../results/figures/paper/Figure_8C.pdf")
plt.close()
